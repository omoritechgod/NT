...
const CaseStudies = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-[#0c267b] to-[#007aff]">
      <Navigation />
      {/* bg-[#0e131f] */}
      <section className="py-[150px]  text-white h-auto md:h-[65vh] ">
      ...
      <section className="max-w-[1200px] w-[98%] py-0 backdrop-blur rounded-xl mb-20 -mt-32 md:-mt-[95px] mx-auto">
