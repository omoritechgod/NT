      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div>
              <h2 className="text-3xl font-bold text-[#1b263a] mb-8">Start Your Project</h2>
              <Card>
                <CardContent className="p-8">
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Button type="submit" className="w-full bg-[#007aff] hover:bg-[#007aff]/80 text-white py-3">
                      Send Message
                    </Button>
                  </form>
                </CardContent>
            ...
            {/* Contact Information */}
            <div>
              <h2 className="text-3xl font-bold text-[#1b263a] mb-8">Get in Touch</h2>
              ...
              <div className="space-y-6 mb-12">
                <Card className="hover:shadow-lg transition-shadow">
                  <CardContent className="p-6 flex items-start">
                    ...
                    <div>
                      <h3 className="font-semibold text-[#1b263a] mb-1">Email Us</h3>
                ...
                <Card className="hover:shadow-lg transition-shadow">
                  <CardContent className="p-6 flex items-start">
                    ...
                    <div>
                      <h3 className="font-semibold text-[#1b263a] mb-1">Call Us</h3>
                ...
                <Card className="hover:shadow-lg transition-shadow">
                  <CardContent className="p-6 flex items-start">
                    ...
                    <div>
                      <h3 className="font-semibold text-[#1b263a] mb-1">Global Presence</h3>
                      <p className="text-gray-600">North America • Europe • Africa</p>
                      <p className="text-gray-600">Remote-first with global reach</p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="hover:shadow-lg transition-shadow">
                  <CardContent className="p-6 flex items-start">
                    ...
                    <div>
                      <h3 className="font-semibold text-[#1b263a] mb-1">Response Time</h3>
              ...
              <Card className="bg-gradient-to-br from-[#007aff] to-[#0c267b] text-white">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-gray-200 mb-6">
                    Chat with our team directly for quick answers to your questions.
                  </p>
