...
import { ArrowRight, Code, Brain, Palette, Smartphone, TrendingUp, Network, Star, ExternalLink, Globe, Users, Award, ChevronRight } from 'lucide-react';
...
const Index = () => {
  ...
  const heroSlides = [
    {
      ...
      description: "Premium technology services that transform businesses and drive digital excellence."
    },
    {
      title: "Excellence Beyond Borders",
      subtitle: "Global Delivery, Local Excellence", 
      description: "Delivering world-class solutions to clients across continents with unmatched precision."
    },
    {
      title: "Building Tomorrow's Digital Landscape",
      subtitle: "AI-Powered Innovation",
      description: "Harness the power of artificial intelligence to revolutionize your business operations."
    }
  ];
  ...
  const solutions = [
    {
      ...
      description: "Complete brand identity solutions with design mockups and comprehensive strategies.",
      link: "/solutions"
    },
    {
      icon: Smartphone,
      title: "UI/UX & Product Design",
      description: "User-centered design approaches that create intuitive, engaging experiences.",
      link: "/solutions"
    },
    {
      icon: Code,
  ...
  const testimonials = [
    {
      ...
      role: "CTO",
      content: "NT delivered exceptional results on our AI integration project. Their expertise and professionalism exceeded all expectations.",
      rating: 5,
      industry: "Technology"
    },
    {
      ...
      company: "InnovateNow",
      role: "CEO",
      content: "The custom software solution NT built for us transformed our operations. Outstanding quality and support throughout.",
      rating: 5,
      industry: "Healthcare"
    },
    {
      ...
      content: "NT's UI/UX design work elevated our product to new heights. Incredible attention to detail and user experience.",
      rating: 5,
      industry: "Finance"
    }
  ];
  ...
  const projects = [
    ...
    },
    {
      ...
      category: "Design",
      description: "Intuitive medical data visualization platform for healthcare providers",
      tech: ["Figma", "React", "D3.js"]
    },
    {
      title: "FinTech Mobile App",
      category: "Mobile", 
      description: "Secure financial management app with biometric authentication",
  ...
  const teamMembers = [
    {
      name: "Alex Thompson",
      role: "CEO & Founder",
      quote: "Innovation is not just about technology—it's about transforming how businesses connect with their customers.",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1494790108755-2616b612ed6d?w=300&h=300&fit=crop&crop=face"
    },
    {
      name: "Marcus Johnson",
      role: "Lead Developer",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#1b263a] to-[#0c267b]">
      ...
      <div className="bg-gradient-to-r from-[#007aff] to-[#0c267b] text-white py-2 px-4 text-center">
        <p className="text-sm">
          🎓 Empowering Africa's Next Digital Leaders with <span className="font-semibold">NT Learn</span>
          <Link to="/nt-learn" className="ml-2 underline hover:no-underline">Explore NT Learn</Link>
        </p>
      </div>
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/solutions">
                <Button size="lg" className="bg-[#007aff] hover:bg-[#007aff]/80 text-white px-8">
                  Explore Our Solutions
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
              <Link to="/case-studies">
                <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-[#1b263a] px-8">
                  See Our Work
                </Button>
              </Link>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-[#1b263a] mb-6">Who We Are</h2>
          <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-8">
            NT is a premium technology company that delivers cutting-edge solutions to businesses worldwide. 
            We combine innovation, expertise, and excellence to transform digital landscapes and drive business success.
          </p>
          <Link to="/about">
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-[#1b263a] mb-4">Our Solutions</h2>
            ...
            {solutions.slice(0, 6).map((solution, index) => (
              <Card key={index} className="group hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-bold text-[#1b263a] mb-4">{solution.title}</h3>
      ...
      <section className="py-20 bg-gradient-to-r from-[#1b263a] to-[#0c267b]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Excellence Beyond Borders</h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            Wherever You Are
          </p>
          <p className="text-lg text-gray-400 max-w-4xl mx-auto">
            Our global delivery model ensures seamless collaboration across time zones, 
            bringing world-class expertise directly to your doorstep. From concept to deployment, 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-[#1b263a] mb-4">Success Stories</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              What our clients say about working with NT across different industries
            </p>
          </div>
            ...
            <Card className="bg-gradient-to-br from-[#1b263a] to-[#0c267b] text-white">
              <CardContent className="p-8 text-center">
                ...
                <div className="text-gray-300">
                  ...
                  <p className="text-[#007aff]">{testimonials[currentTestimonial].company}</p>
                  <p className="text-sm text-gray-400">{testimonials[currentTestimonial].industry}</p>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="flex justify-center mt-8 space-x-2">
              {testimonials.map((_, index) => (
                <button
                  key={index}
                  className={`w-3 h-3 rounded-full transition-all ${
                    currentTestimonial === index ? 'bg-[#007aff]' : 'bg-gray-300'
                  }`}
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-[#1b263a] mb-4">Project Highlights</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-[#1b263a] mb-4">Meet the Team</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            ...
            {teamMembers.map((member, index) => (
              <Card key={index} className="text-center hover:shadow-xl transition-shadow">
                <CardContent className="p-8">
                  ...
                  />
                  <h3 className="text-xl font-bold text-[#1b263a] mb-2">{member.name}</h3>
                  <p className="text-[#007aff] font-medium mb-4">{member.role}</p>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-[#1b263a] mb-4">Latest Insights</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            ...
            {[
              ...
              <Card key={index} className="hover:shadow-xl transition-shadow cursor-pointer">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-[#1b263a] mb-3">{post.title}</h3>
      ...
      <section className="py-20 bg-gradient-to-r from-[#0c267b] to-[#007aff]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Let's Build Something Remarkable</h2>
